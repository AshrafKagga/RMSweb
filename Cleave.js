      ...
      (function (t) {
        ...
        (i.prototype = {
          ...
          onKeyDown: function (e) {
            ...
            r.postDelimiterBackspace = !(8 !== n || !l) && l;
          },
          onChange: function () {
          ...
          updateCreditCardPropsByValue: function (e) {
            var t,
              r = this.properties,
              n = i.Util;
            n.headStr(r.result, 4) !== n.headStr(e, 4) &&
              ((t = i.CreditCardDetector.getInfo(e, r.creditCardStrictMode)),
              (r.blocks = t.blocks),
          ...
          getRawValue: function () {
            ...
            return (
              ...
              (r = e.numeral
                ? e.numeralFormatter.getRawValue(r)
                : t.stripDelimiters(r, e.delimiter, e.delimiters))
            );
          },
          ...
          format: function (e) {
            ...
            switch (
              ...
              e.indexOf(o.numeralDecimalMark) >= 0 &&
                ((a = (t = e.split(o.numeralDecimalMark))[0]),
                (l =
